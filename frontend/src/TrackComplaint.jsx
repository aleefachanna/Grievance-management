  ...
  return (
    <div className="resolve-wrapper">
      <div className="resolve-card">
        ...
        {complaintData && (
          <div style={{ marginTop: "25px", padding: "20px", background: "#0f0f0fff", borderRadius: "8px", borderLeft: "4px solid #3498db" }}>
            <h3 style={{ margin: "0 0 15px 0", color: "#dbe0e5ff", display: 'flex', justifyContent: 'space-between' }}>
            ...
            <p style={{ margin: 0, color: "#f3eeeeff" }}>{complaintData.description}</p>
            ...
            {complaintData.public_updates && complaintData.public_updates.length > 0 && (
              <div style={{ marginTop: '20px', borderTop: '1px solid #151414ff', paddingTop: '15px' }}>
                <h4 style={{ margin: '0 0 10px 0', color: '#f1f7fcff' }}>Timeline & Updates</h4>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  {complaintData.public_updates.map(update => (
                    <div key={update.id} style={{ background: '#fff', border: '1px solid #eee', padding: '10px', borderRadius: '6px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px', fontSize: '11px', color: '#bfd2d3ff' }}>
